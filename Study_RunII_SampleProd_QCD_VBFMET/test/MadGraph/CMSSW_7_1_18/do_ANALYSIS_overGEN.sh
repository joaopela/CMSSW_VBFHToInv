...
cmsRun run_ANALYSIS_overGEN_cfg.py print inputFiles=file:prod_v0/CMSSW_7_1_18_Hadronizer.root  outputFile=file:prod_v0/PartonGenJetAnalyzer_QCD_VBFLike_all.root maxEvents=-1 dijetPt=30 dijetMjj=800
