...
process.source = cms.Source("PoolSource",
     fileNames = cms.untracked.vstring('root://xrootd.unl.edu//store/user/chayanit/QCD_Pt-80to120_Tune4C_13TeV_pythia8/TrigStudies2015_720_L1plusHLT_v1_PU40bx25_QCD_Pt-80to120/d9ec0993de5dab2a1e7afeea7cd4800d/outputA_100_1_zbu.root')
...
process.hltCtrlPathStudies = cms.EDAnalyzer('HLTCtrlPathStudies',
  ...
  #HLTPathFired = cms.untracked.vstring("HLT_PFMET_PFVBF_Unseeded_v1"),
  #HLTObject    = cms.untracked.vstring("hltDiPFJet20MJJ500AllJetsDEta2p5"),
  ...
  outputFilename = cms.untracked.string("HLTCtrlPathStudiesResults.root"),
...
process.p += process.hltCtrlPathStudies
