...
# with command line options: Configuration/GenProduction/python/BTV-Fall13-00049-fragment.py --fileout file:QCD_Pt-600to800_step1.root --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/StandardSequences/SimWithCastor_cff.customise,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --pileup_input dbs:/MinBias_TuneA2MB_13TeV-pythia8/Fall13-POSTLS162_V1-v1/GEN-SIM --pileup AVE_35_BX_50ns,{"N":30} --conditions PHYS14_ST_V1 --step GEN,SIM,DIGI,L1,DIGI2RAW,HLT:GRun --magField 38T_PostLS1 --geometry Extended2015 --python_filename QCD_Pt-600to800_step1_cfg.py --no_exec -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Fall13 sample with PYTHIA8: QCD dijet production, pThat = 600 .. 800 GeV, Tune4C')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:QCD_Pt-600to800_step1.root'),
...
from VBFHiggsToInvisible.GenFilters.MCDijetFilter_cfi import *
process.filterDijet = mcDijetFilter_Pt50_Eta4p75_DEta3p5_Dphi1p5_Mjj1000
...
# The offline analysis schedule
#process.OfflineAnalysis_path = cms.Path(process.offlineFilterAnalyzer)
#process.OfflineAnalysis_step = cms.Schedule(process.OfflineAnalysis_path)
...
for path in process.paths:
        getattr(process,path)._seq = process.generator  *process.genParticles *process.genParticlesForJetsNoNu *process.ak5GenJetsNoNu *process.filterDijet * getattr(process,path)._seq 
        #getattr(process,path)._seq = process.generator *process.randomEngineStateProducer *process.VtxSmeared *process.genParticles *process.genParticlesForJetsNoNu *process.ak5GenJetsNoNu *process.filterDijet * getattr(process,path)._seq 
