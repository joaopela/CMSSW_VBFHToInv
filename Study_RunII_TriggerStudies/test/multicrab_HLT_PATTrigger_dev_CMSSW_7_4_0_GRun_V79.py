...
strHCALMethod = 'HCALMethod'+args['hcalMethod']
...
config.General.workArea   = 'HLT_PATTrigger_'+strHLTMenu+'/'+puScenario+'/'strHCALMethod
config.Data.outLFNDirBase = '/store/user/pela/2015/HLT_PATTrigger_'+strHLTMenu+'/'+puScenario+'/'strHCALMethod+'/'
  
if args['hcalMethod'] is '0':
  config.JobType.psetName   = 'rerunHLT_Phys14_dev_CMSSW_7_4_0_GRun_V79_HCALMethod0_cfg.py'

elif args['hcalMethod'] is '2':
  config.JobType.psetName   = 'rerunHLT_Phys14_dev_CMSSW_7_4_0_GRun_V79_HCALMethod2_cfg.py'

elif args['hcalMethod'] is '3':
  config.JobType.psetName   = 'rerunHLT_Phys14_dev_CMSSW_7_4_0_GRun_V79_HCALMethod3_cfg.py'

else:
  print "Wrong HCAL Method"
  sys.exit(1)
...
if args['mcCampaign']=='Phys14' and args['puScenario']=='PU40bx25':
  ...
  tasks.append(('VBF_HToInv_M-125_PU40bx25', '/VBF_HToInv_M-125_13TeV_powheg-pythia6/Phys14DR-PU20bx25_tsg_PHYS14_25_V1-v1/GEN-SIM-RAW',          'PU40bx25_HLT_PATTrigger_dev_CMSSW_7_4_0_GRun_V79_HCALMethod'+args['hcalMethod']))
  ...
  tasks.append(('VBF_HToInv_M-125_AVE30BX50', '/VBF_HToInv_M-125_13TeV_powheg-pythia6/Phys14DR-PU40bx25_PHYS14_25_V1-v2/GEN-SIM-RAW',             'PU30bx50_HLT_PATTrigger_dev_CMSSW_7_4_0_GRun_V79_HCALMethod'+args['hcalMethod']))
  tasks.append(('QCD_Pt-30to50_AVE30BX50',    '/QCD_Pt-30to50_Tune4C_13TeV_pythia8/Phys14DR-AVE30BX50_tsg_castor_PHYS14_ST_V1-v2/GEN-SIM-RAW',    'PU30bx50_HLT_PATTrigger_dev_CMSSW_7_4_0_GRun_V79_HCALMethod'+args['hcalMethod']))
  tasks.append(('QCD_Pt-50to80_AVE30BX50',    '/QCD_Pt-50to80_Tune4C_13TeV_pythia8/Phys14DR-AVE30BX50_tsg_castor_PHYS14_ST_V1-v1/GEN-SIM-RAW',    'PU30bx50_HLT_PATTrigger_dev_CMSSW_7_4_0_GRun_V79_HCALMethod'+args['hcalMethod']))
  tasks.append(('QCD_Pt-80to120_AVE30BX50',   '/QCD_Pt-80to120_Tune4C_13TeV_pythia8/Phys14DR-AVE30BX50_tsg_castor_PHYS14_ST_V1-v1/GEN-SIM-RAW',   'PU30bx50_HLT_PATTrigger_dev_CMSSW_7_4_0_GRun_V79_HCALMethod'+args['hcalMethod']))
  tasks.append(('QCD_Pt-120to170_AVE30BX50',  '/QCD_Pt-120to170_Tune4C_13TeV_pythia8/Phys14DR-AVE30BX50_tsg_castor_PHYS14_ST_V1-v1/GEN-SIM-RAW',  'PU30bx50_HLT_PATTrigger_dev_CMSSW_7_4_0_GRun_V79_HCALMethod'+args['hcalMethod']))
  tasks.append(('QCD_Pt-170to300_AVE30BX50',  '/QCD_Pt-170to300_Tune4C_13TeV_pythia8/Phys14DR-AVE30BX50_tsg_castor_PHYS14_ST_V1-v1/GEN-SIM-RAW',  'PU30bx50_HLT_PATTrigger_dev_CMSSW_7_4_0_GRun_V79_HCALMethod'+args['hcalMethod']))
  tasks.append(('QCD_Pt-300to470_AVE30BX50',  '/QCD_Pt-300to470_Tune4C_13TeV_pythia8/Phys14DR-AVE30BX50_tsg_castor_PHYS14_ST_V1-v1/GEN-SIM-RAW',  'PU30bx50_HLT_PATTrigger_dev_CMSSW_7_4_0_GRun_V79_HCALMethod'+args['hcalMethod']))
  tasks.append(('QCD_Pt-470to600_AVE30BX50',  '/QCD_Pt-470to600_Tune4C_13TeV_pythia8/Phys14DR-AVE30BX50_tsg_castor_PHYS14_ST_V1-v1/GEN-SIM-RAW',  'PU30bx50_HLT_PATTrigger_dev_CMSSW_7_4_0_GRun_V79_HCALMethod'+args['hcalMethod']))
  tasks.append(('QCD_Pt-600to800_AVE30BX50',  '/QCD_Pt-600to800_Tune4C_13TeV_pythia8/Phys14DR-AVE30BX50_tsg_castor_PHYS14_ST_V1-v1/GEN-SIM-RAW',  'PU30bx50_HLT_PATTrigger_dev_CMSSW_7_4_0_GRun_V79_HCALMethod'+args['hcalMethod']))
  tasks.append(('QCD_Pt-800to1000_AVE30BX50', '/QCD_Pt-800to1000_Tune4C_13TeV_pythia8/Phys14DR-AVE30BX50_tsg_castor_PHYS14_ST_V1-v1/GEN-SIM-RAW', 'PU30bx50_HLT_PATTrigger_dev_CMSSW_7_4_0_GRun_V79_HCALMethod'+args['hcalMethod']))
  tasks.append(('QCD_Pt-1000to1400_AVE30BX50','/QCD_Pt-1000to1400_Tune4C_13TeV_pythia8/Phys14DR-AVE30BX50_tsg_castor_PHYS14_ST_V1-v1/GEN-SIM-RAW','PU30bx50_HLT_PATTrigger_dev_CMSSW_7_4_0_GRun_V79_HCALMethod'+args['hcalMethod']))
  ...
  tasks.append(('QCD_Pt_80to120',   '/QCD_Pt_80to120_TuneCUETP8M1_13TeV_pythia8/RunIISpring15Digi74-AVE_20_BX_25ns_tsg_MCRUN2_74_V7-v2/GEN-SIM-RAW   ','HLT_PATTrigger_'+strHLTMenu+'_'+puScenario+'_'strHCALMethod))
  tasks.append(('QCD_Pt_120to170',  '/QCD_Pt_120to170_TuneCUETP8M1_13TeV_pythia8/RunIISpring15Digi74-AVE_20_BX_25ns_tsg_MCRUN2_74_V7-v1/GEN-SIM-RAW  ','HLT_PATTrigger_'+strHLTMenu+'_'+puScenario+'_'strHCALMethod))
  tasks.append(('QCD_Pt_170to300',  '/QCD_Pt_170to300_TuneCUETP8M1_13TeV_pythia8/RunIISpring15Digi74-AVE_20_BX_25ns_tsg_MCRUN2_74_V7-v1/GEN-SIM-RAW  ','HLT_PATTrigger_'+strHLTMenu+'_'+puScenario+'_'strHCALMethod))
  tasks.append(('QCD_Pt_300to470',  '/QCD_Pt_300to470_TuneCUETP8M1_13TeV_pythia8/RunIISpring15Digi74-AVE_20_BX_25ns_tsg_MCRUN2_74_V7-v1/GEN-SIM-RAW  ','HLT_PATTrigger_'+strHLTMenu+'_'+puScenario+'_'strHCALMethod))
  tasks.append(('QCD_Pt_470to600',  '/QCD_Pt_470to600_TuneCUETP8M1_13TeV_pythia8/RunIISpring15Digi74-AVE_20_BX_25ns_tsg_MCRUN2_74_V7-v1/GEN-SIM-RAW  ','HLT_PATTrigger_'+strHLTMenu+'_'+puScenario+'_'strHCALMethod))
  tasks.append(('QCD_Pt_600to800',  '/QCD_Pt_600to800_TuneCUETP8M1_13TeV_pythia8/RunIISpring15Digi74-AVE_20_BX_25ns_tsg_MCRUN2_74_V7-v1/GEN-SIM-RAW  ','HLT_PATTrigger_'+strHLTMenu+'_'+puScenario+'_'strHCALMethod))
  tasks.append(('QCD_Pt_800to1000', '/QCD_Pt_800to1000_TuneCUETP8M1_13TeV_pythia8/RunIISpring15Digi74-AVE_20_BX_25ns_tsg_MCRUN2_74_V7-v1/GEN-SIM-RAW ','HLT_PATTrigger_'+strHLTMenu+'_'+puScenario+'_'strHCALMethod))
  tasks.append(('QCD_Pt_1000to1400','/QCD_Pt_1000to1400_TuneCUETP8M1_13TeV_pythia8/RunIISpring15Digi74-AVE_20_BX_25ns_tsg_MCRUN2_74_V7-v1/GEN-SIM-RAW','HLT_PATTrigger_'+strHLTMenu+'_'+puScenario+'_'strHCALMethod))
  tasks.append(('QCD_Pt_1400to1800','/QCD_Pt_1400to1800_TuneCUETP8M1_13TeV_pythia8/RunIISpring15Digi74-AVE_20_BX_25ns_tsg_MCRUN2_74_V7-v1/GEN-SIM-RAW','HLT_PATTrigger_'+strHLTMenu+'_'+puScenario+'_'strHCALMethod))
  tasks.append(('QCD_Pt_1800to2400','/QCD_Pt_1800to2400_TuneCUETP8M1_13TeV_pythia8/RunIISpring15Digi74-AVE_20_BX_25ns_tsg_MCRUN2_74_V7-v1/GEN-SIM-RAW','HLT_PATTrigger_'+strHLTMenu+'_'+puScenario+'_'strHCALMethod))
  tasks.append(('QCD_Pt_2400to3200','/QCD_Pt_2400to3200_TuneCUETP8M1_13TeV_pythia8/RunIISpring15Digi74-AVE_20_BX_25ns_tsg_MCRUN2_74_V7-v1/GEN-SIM-RAW','HLT_PATTrigger_'+strHLTMenu+'_'+puScenario+'_'strHCALMethod))
  tasks.append(('QCD_Pt_3200toInf', '/QCD_Pt_3200toInf_TuneCUETP8M1_13TeV_pythia8/RunIISpring15Digi74-AVE_20_BX_25ns_tsg_MCRUN2_74_V7-v1/GEN-SIM-RAW ','HLT_PATTrigger_'+strHLTMenu+'_'+puScenario+'_'strHCALMethod))
