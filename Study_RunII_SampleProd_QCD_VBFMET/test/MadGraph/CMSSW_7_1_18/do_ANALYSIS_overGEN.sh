...
cmsRun run_ANALYSIS_overGEN_cfg.py print inputFiles=file:v1/CMSSW_7_1_18_Hadronizer_QCD_VBFLike_jjjj.root outputFile=file:v1/PartonGenJetAnalyzer_QCD_VBFLike_jjjj.root maxEvents=-1
cmsRun run_ANALYSIS_overGEN_cfg.py print inputFiles=file:v1/CMSSW_7_1_18_Hadronizer_QCD_VBFLike_all.root  outputFile=file:v1/PartonGenJetAnalyzer_QCD_VBFLike_all.root  maxEvents=-1