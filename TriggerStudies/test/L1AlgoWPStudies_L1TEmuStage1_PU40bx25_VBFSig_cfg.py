...
process.load("VBFHiggsToInvisible.Samples.VBF_HToInv_M-125_13TeV_powheg-pythia6_pela-TrigStudies_Run2015_L1Emulator_Stage1_v1_PU40bx25_VBF_HToInv_M-125_13TeV_powheg-pythia_USER_cfi")
...
process.trgCount = cms.EDAnalyzer('TrigStudies',
  ...
  outputFilename = cms.untracked.string("TrigStudiesResults_L1TEmuStage1_VBFInv_PU40bx25.root"),
...
process.trgEff = cms.EDAnalyzer('L1AlgoWPStudies',
  ...
  outputFilename = cms.untracked.string("L1AlgoWPStudiesResults_L1TEmuStage1_VBFInv_PU40bx25.root"),  
)
