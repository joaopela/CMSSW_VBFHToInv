...
process.filterMCMET = cms.EDFilter("MCMETFilter",
  MCMET   = cms.untracked.double(40.0),
  outFile = cms.untracked.string('met_QCD_Pt-600to800.root')
)
...
for path in process.paths:
        getattr(process,path)._seq = process.generator *process.genParticles *process.genParticlesForJetsNoNu *process.ak5GenJetsNoNu *process.filterDijet *process.filterMCMET * getattr(process,path)._seq 
