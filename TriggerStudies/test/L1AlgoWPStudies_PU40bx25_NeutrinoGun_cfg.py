...
process.load("VBFHiggsToInvisible.Samples.Neutrino_Pt-2to20_gun_pela-TrigStudies2015_Legacy_L1Extra_PU40bx25_Neutrino_Pt-2to20_gun_USER_cfi")
...
process.trgEff = cms.EDAnalyzer('L1AlgoWPStudies',
  ...
  outputFilename = cms.untracked.string("L1AlgoWPStudiesResults_NeutrinoGun_PU40bx25.root"),  
)
