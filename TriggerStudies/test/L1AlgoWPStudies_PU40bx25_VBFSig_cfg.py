...
process.load("VBFHiggsToInvisible.Samples.VBF_HToInv_M-125_13TeV_powheg-pythia6_pela-TrigStudies2015_Legacy_L1Extra_PU40bx25_VBF_HToInv_M-125_13TeV_powheg-pythia6_USER_cfi")
#process.load("VBFHiggsToInvisible.Samples.VBF_HToInv_M-125_13TeV_powheg-pythia6_pela-TrigStudies_Run2015_Legacy_ReRunHLT_v3_PU40bx25_VBF_HToInv_M-125_13TeV_powheg-pythia6_USER_cfi")
...
process.trgEff = cms.EDAnalyzer('L1AlgoWPStudies',
  ...
  outputFilename = cms.untracked.string("L1AlgoWPStudiesResults_VBFInv_PU40bx25.root"),  
)
