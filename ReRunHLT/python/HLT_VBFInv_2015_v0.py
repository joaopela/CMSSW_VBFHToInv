# /users/jbrooke/vbfHinv/716/V1 (CMSSW_7_1_6)

import FWCore.ParameterSet.Config as cms


HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/jbrooke/vbfHinv/716/V1')
)
...
hltPreMET80VBF40 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
hltDiCaloJet40MJJ600AllJetsDEta3Filter = cms.EDFilter( "HLTCaloJetVBFFilter",
    saveTags = cms.bool( True ),
    minDeltaEta = cms.double( 3.0 ),
    leadingJetOnly = cms.bool( False ),
    maxEta = cms.double( 5.0 ),
...
hltDiPFJet40MJJ800AllJetsDEta35Filter = cms.EDFilter( "HLTPFJetVBFFilter",
    saveTags = cms.bool( False ),
...
HLT_PFMET180_NoiseCleaned_v1 = cms.Path( HLTBeginSequence + hltL1sL1ETM36ORETM40 + hltPrePFMET180NoiseCleaned + HLTRecoMETSequence + hltMET90 + HLTHBHENoiseCleanerSequence + hltMetClean + hltMETClean80 + HLTAK4CaloJetsSequence + hltMetCleanUsingJetID + hltMETCleanUsingJetID80 + HLTAK4PFJetsSequence + hltPFMETProducer + hltPFMET180Filter + HLTEndSequence )
...
HLT_Photon135_VBF_v1 = cms.Path( HLTBeginSequence + hltL1sL1SingleEG30 + hltPreMET80VBF40 + HLTSinglePhoton135Sequence + HLTAK4CaloJetsSequence + hltDiCaloJet20MJJ400AllJetsDEta3Filter + HLTEndSequence )
HLT_MET80_VBF40_v1 = cms.Path( HLTBeginSequence + hltL1sL1ETM70 + hltPreMET80VBF40 + HLTRecoMETSequence + hltMET65 + HLTAK4CaloJetsSequence + hltDiCaloJet40MJJ600AllJetsDEta3Filter + HLTAK4PFJetsSequence + hltDiPFJet40MJJ800AllJetsDEta35Filter + hltPFMETProducer + hltPFMET80Filter + HLTEndSequence )
...
HLTSchedule = cms.Schedule( *(HLTriggerFirstPath, HLT_PFJet40_v1, HLT_PFMET180_NoiseCleaned_v1, HLT_PFchMET90_NoiseCleaned_v1, HLT_Photon135_VBF_v1, HLT_MET80_VBF40_v1, HLTriggerFinalPath, HLTAnalyzerEndpath ))
