...
mkdir gridpack_v2/all/
vbfinv_qcdSamplesRunII_madgraph_hadronization -i gridpack_v2/PartonGenJetAnalyzer_QCD_VBFLike_all.root  -d gridpack_v2/all/  | tee gridpack_v2/all/run.log