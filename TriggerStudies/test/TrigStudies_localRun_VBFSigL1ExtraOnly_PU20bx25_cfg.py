...
process.load("VBFHiggsToInvisible.Samples.VBF_HToInv_M-125_13TeV_powheg-pythia6_pela-TrigStudies2015_Legacy_L1Extra_PU20bx25_VBF_HToInv_M-125_13TeV_powheg-pythia6_USER_cfi")
...
process.trgEff = cms.EDAnalyzer('TrigStudies',
  ...
  outputFilename = cms.untracked.string("TrigStudiesResults_VBFInv_PU20bx25.root"),
  ...
  algoTesterAlgos = cms.vstring("L1_DoubleJetC60_ETM60",
                                ...
                                "L1_DoubleVBFJet40_DEta3p0_ETM4",
