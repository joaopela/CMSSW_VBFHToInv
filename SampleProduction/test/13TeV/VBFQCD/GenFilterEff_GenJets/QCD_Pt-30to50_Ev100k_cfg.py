...
# with command line options: Configuration/GenProduction/python/BTV-Fall13-00042-fragment.py --fileout file:QCD_Pt-30to50_step1.root --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/StandardSequences/SimWithCastor_cff.customise,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --pileup_input dbs:/MinBias_TuneA2MB_13TeV-pythia8/Fall13-POSTLS162_V1-v1/GEN-SIM --pileup AVE_35_BX_50ns,{"N":30} --conditions PHYS14_ST_V1 --step GEN,SIM,DIGI,L1,DIGI2RAW,HLT:GRun --magField 38T_PostLS1 --geometry Extended2015 --python_filename QCD_Pt-30to50_step1_cfg.py --no_exec -n 100
...
process.filterDijet = cms.EDFilter("MCDijetFilter",
  ...
  outFile = cms.untracked.string('dijet_QCD_Pt-30to50.root')
)
