# /users/jbrooke/vbfHinv/dev/V6 (CMSSW_7_2_0_pre8)

import FWCore.ParameterSet.Config as cms

process = cms.Process( "TEST" )

process.load("VBFHiggsToInvisible/RunL1Emulator_Stage1/setup_cff")

process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/jbrooke/vbfHinv/dev/V6')
)
...
process.hltMET65X = cms.EDFilter( "HLT1CaloMET",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 10.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( -1.0 ),
...
process.hltDiCaloJet40MJJ600AllJetsDEta3FilterX = cms.EDFilter( "HLTCaloJetVBFFilter",
    saveTags = cms.bool( True ),
    minDeltaEta = cms.double( 2.5 ),
    leadingJetOnly = cms.bool( False ),
    maxEta = cms.double( 5.0 ),
...
process.hltDiPFJet40MJJ800AllJetsDEta35FilterX = cms.EDFilter( "HLTPFJetVBFFilter",
    saveTags = cms.bool( True ),
    minDeltaEta = cms.double( 2.5 ),
    leadingJetOnly = cms.bool( False ),
    maxEta = cms.double( 5.0 ),
...
process.hltPFMET80FilterX = cms.EDFilter( "HLTMhtFilter",
    saveTags = cms.bool( True ),
    mhtLabels = cms.VInputTag( 'hltPFMETProducer' ),
    minMht = cms.vdouble( 10.0 )
)
...
process.hltDiCaloJet10 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 10.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( -1.0 ),
...
process.hltDiPFJet10 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 10.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( -1.0 ),
    ...
    inputTag = cms.InputTag( "hltAK4PFJetsCorrected" ),
    MinE = cms.double( -1.0 ),
    triggerType = cms.int32( 2 )
)

process.HLT_CaloMET_CaloVBF_v1 = cms.Path( process.HLTBeginSequence + process.hltPreMET80VBF40 + process.HLTRecoMETSequence + process.hltMET65 + process.HLTAK4CaloJetsSequence + process.hltDiCaloJet10 + process.hltDiCaloJet40MJJ600AllJetsDEta3Filter + process.HLTEndSequence )

process.HLT_PFMET_PFVBF_v1 = cms.Path( process.HLTBeginSequence + process.hltPreMET80VBF40 + process.HLTRecoMETSequence + process.HLTAK4CaloJetsSequence + process.HLTAK4PFJetsSequence + process.hltDiPFJet10 + process.hltDiPFJet40MJJ800AllJetsDEta35Filter + process.hltPFMETProducer + process.hltPFMET80Filter + process.HLTEndSequence )
