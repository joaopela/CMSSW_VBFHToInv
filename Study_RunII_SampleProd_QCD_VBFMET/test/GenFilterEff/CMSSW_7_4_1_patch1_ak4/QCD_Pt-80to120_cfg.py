...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    crossSection = cms.untracked.double(2762530.0),
...
process.genFilterAnalyzer.outFile                   = cms.untracked.string('GenFilterAnalyzer_QCD_Pt-80to120_'+str(JOBNUMBER)+'.root')
