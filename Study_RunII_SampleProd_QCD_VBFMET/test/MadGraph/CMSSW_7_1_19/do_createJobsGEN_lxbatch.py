...
for x in range(sJobs,nJobs):
  ...
  with open(path,'w') as fOut:
    ...
    fOut.write("\n")
    fOut.write("tar -xvaf /afs/cern.ch/work/p/pela/public/qcd_vbf_samples/gridpack_v3/qcd_vbf_tarball.tar.xz\n")
    fOut.write("./runcmsgrid.sh $EVENTS $JOB 1\n")
    fOut.write("\n")
    fOut.write("mv cmsgrid_final.lhe /afs/cern.ch/work/p/pela/public/qcd_vbf_samples/gridpack_v3/events/ev_seed${JOB}_n${EVENTS}.lhe\n")
