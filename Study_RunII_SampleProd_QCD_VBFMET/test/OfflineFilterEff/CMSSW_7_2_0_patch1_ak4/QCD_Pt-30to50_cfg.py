...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Fall13 sample with PYTHIA8: QCD dijet production, pThat = 30 .. 50 GeV, Tune4C')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    outputCommands = cms.untracked.vstring('keep *',
                                           ...
                                           'drop EEDigiCollection_simEcalUnsuppressedDigis_*_*',
