...
process.load("VBFHiggsToInvisible.Samples.Neutrino_Pt-2to20_gun_pela-TrigStudies_Run2015_Legacy_ReRunHLT_v3_PU40bx50_Neutrino_Pt-2to20_gun_USER_cfi")
...
process.trgCount = cms.EDAnalyzer('TrigStudies',
  ...
  outputFilename = cms.untracked.string("TrigStudiesResults_NeutrinoGun_PU40bx50.root"),
...
process.trgEff = cms.EDAnalyzer('L1AlgoWPStudies',
  ...
  outputFilename = cms.untracked.string("L1AlgoWPStudiesResults_NeutrinoGun_PU40bx50.root"),  
)
